...
const ConfirmRidePopUp = (props) => {
 ...
 <div className="flex gap-2 justify-between flex-col items-center">
   ...
   <form onSubmit={(e) =>{
    ...
    }} type="text" placeholder="Enter OTP" className="bg-[#eeeeee] px-6 py-4 font-mono rounded-lg w-full mt-5 mb-3"/>


   <Link to='/captain-riding'  className="flex justify-center w-full mt- bg-green-600 text-white text-lg font-semibold p-3 rounded-lg">
          Confirm
        </Link>
